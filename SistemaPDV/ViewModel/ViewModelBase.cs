...
namespace SistemaPDV
{
    public class ViewModelBase : INotifyPropertyChanged
    {
        ...
        /// <summary>
        /// Janela é o arquivo que será carregado, content é o painel onde será carregado.
        /// </summary>
        /// <param name="janela"></param>
        /// <param name="Content"></param>
        public void NovaPagina(Control janela, Control Content)
        {
